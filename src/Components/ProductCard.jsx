...
function ProductCard({ product, isChecked, onCheck }) {
  ...
  return (
    <div className="group hover:bg-[#f7f7f7] cursor-pointer flex items-stretch bg-white border-b border-gray-300 relative">
      {/* Sticky Checkbox */}
      <div className="sticky left-0 z-20 w-[36px] min-w-[36px] bg-white group-hover:bg-[#f7f7f7] p-[6px_6px_6px_12px] flex items-center">
        <input
          type="checkbox"
      ...
      {/* Sticky Image */}
      <div className="sticky left-[36px] z-20 w-[52px] min-w-[52px] bg-white group-hover:bg-[#f7f7f7] p-[6px] flex items-center justify-center ">
        <div className="w-[40px] h-[40px] rounded-[6px] border border-[#D3D3D3] bg-white overflow-hidden">
          <img
            src={product.image}
            alt=""
      ...
      {/* Product Name */}
      <div className="w-[200px] min-w-[200px] p-[6px] flex items-center">
        <a
          href="#"
          className="text-[12px] font-medium text-[#303030] hover:underline leading-[16px]"
        >
          {product.Product}
        </a>
      </div>
      ...
      {/* Status */}
      <div className="w-[110px] min-w-[110px] p-[6px] flex items-center">
        <span
      ...
      {/* Inventory */}
      <div className="w-[191px] min-w-[191px] p-[6px] flex items-center text-[12px] font-[500] text-[#303030]">
        {product.Inventory}
      </div>

      {/* Category */}
      <div className="w-[110px] flex-1 min-w-[110px] p-[6px] flex items-center text-[12px] text-[#303030]">
        {product.Category}
      </div>

      {/* Channels - Keep the full dropdown logic */}
      <div className="  relative w-[129px] min-w-[129px] p-[6px] flex items-center justify-center  text-[12px] text-[#303030] hover:bg-[#EAEAEA] cursor-pointer">
        <div
          onClick={() => setIsopen(!open)}
          className="flex items-center justify-end px-2 py-1  cursor-pointer rounded-md transition-all w-full"
        >
          <span className="text-[12px] text-gray-800">{product.Channels}</span>
          <svg
        ...
        {/* Dropdown Menu - Same as original */}
        {open && (
          <>
            ...
            <div className="absolute top-full right-0 mt-2 p-[6px] w-[225px] bg-white border border-gray-200 rounded-[16px] shadow-lg z-[70] overflow-hidden text-left">
              ...
              <div className="p-[8px] flex items-center gap-3 hover:bg-gray-50 ">
      ...
      {/* Catalogs */}
      <div className="w-[129px] min-w-[129px]  p-[6px] flex items-center justify-center text-[12px] text-[#303030] hover:bg-[#EAEAEA] cursor-pointer">
        {product.Catalogs}
      </div>

      {/* Sticky Actions */}
      <div className="sticky right-0 z-20 w-[44px] min-w-[44px] bg-white group-hover:bg-[#f7f7f7] p-[6px] flex items-center justify-center">
        <button
          type="button"
